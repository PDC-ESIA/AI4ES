...
from tools.file_tools import extract_text, run_slicer, run_search, add_to_glossary, check_glossary
...
def create_glossario_agent():
    ...
    return Agent(
        ...
        """,
        tools=[extract_text, run_slicer, run_search, add_to_glossary, check_glossary]
    )
