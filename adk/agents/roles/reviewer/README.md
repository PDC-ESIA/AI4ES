...
Fornecer um diff contendo credenciais (senhas ou tokens) hardcoded no código. O agente deve identificar a falha de segurança e reprovar a revisão no relatório.
