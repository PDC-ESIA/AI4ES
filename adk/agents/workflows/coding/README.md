...
- **Testes:** Suíte base em `adk/tests/`.
...
Solicitação de nova feature genérica. Valida-se se os 6 agentes são instanciados sequencialmente sem interrupção de contexto.
