...
from agents.roles.requirements import prompt as req_prompt
from agents.roles.requirements import schemas as req_schemas
from agents.roles.requirements.tools_requirements import (
    tool_ler_prd_arquivo_adk,
    tool_gerar_doubt_artifact_adk,
)
from agents.roles.coder import prompt as coder_prompt
from agents.roles.reviewer import prompt as reviewer_prompt
...
_requirements = LlmAgent(
    ...
    output_schema=req_schemas.RequirementsOutput,
    output_key="requirements",
    tools=[tool_ler_prd_arquivo_adk, tool_gerar_doubt_artifact_adk],
)
