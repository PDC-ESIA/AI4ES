"""Schemas Pydantic do relatório de erro do Executor do workflow coding_review.

Define o `ErrorReport` entregue ao coder quando o veredito é 'reprovado', com
seus componentes `FailedCriterion` (critério não atendido, verbatim do veredito)
e `FailedStage` (estágio do harness em falha, com evidência bruta). Montado
DETERMINISTICAMENTE pelo callback do executor — o LLM não redige este objeto.
"""
