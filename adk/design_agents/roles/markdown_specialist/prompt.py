...
design_agents/shared/templates/relatorio_design_template.md, substituindo cada marcador pelo conteúdo real.
...
- "Leia o arquivo design_agents/shared/templates/relatorio_design_template.md"
...
- Template: design_agents/shared/templates/relatorio_design_template.md
